...
#define MAX_MOTOR_SPEED 125    /**< Sets the Maximum PWM Duty Cycle for Line Follower Robot 0=0% 255=100% */
...
void loop() {
  ...
  if(currentMillis - previousMillis >= 10){
    ...
    if(automat==HIGH){
      ...
      motor_speed_a = Speed + PID_output;
      motor_speed_b = Speed - PID_output;
      /*
